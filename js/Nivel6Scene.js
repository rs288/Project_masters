        class Nivel6Scene extends Phaser.Scene {
            ...
            create() {
                ...
                const background = this.add.image(0, 0, 'nivel6');
                ...
                this.villano = this.add.image(650, 500, 'villano6');
            ...
            drawOvals(questionBox) {
                ...
                const opciones = questions6[this.currentQuestionIndex].options;
                // Dibuja tres óvalos
                for (let i = 0; i < 3; i++) {
            ...
            showQuestion(questionBox) {
                const question = questions6[this.currentQuestionIndex]; // Obtén la pregunta actual
            ...
            checkAnswer(selectedIndex) {
                const question = questions6[this.currentQuestionIndex];
