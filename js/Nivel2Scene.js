        class Nivel2Scene extends Phaser.Scene {
            ...
            create() {
                ...
                const background = this.add.image(0, 0, 'nivel2');
             ...
             //   this.showQuestion();
                ...
                this.villano = this.add.image(650, 510, 'villano2');
            ...
            drawOvals(questionBox) {
                ...
                const opciones = questions2[this.currentQuestionIndex].options;
                // Dibuja tres óvalos
                for (let i = 0; i < 3; i++) {
            ...
            showQuestion(questionBox) {
                const question = questions2[this.currentQuestionIndex]; // Obtén la pregunta actual
            ...
            checkAnswer(selectedIndex) {
                const question = questions2[this.currentQuestionIndex];
            ...
            nextQuestion() {
                ...
                if (this.currentQuestionIndex < questions2.length) {
                    this.showQuestion(this.questionBox);
                    this.drawOvals(this.questionBox);
                }  else {
