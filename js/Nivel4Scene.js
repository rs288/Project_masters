        class Nivel4Scene extends Phaser.Scene {
            ...
            create() {
                ...
                const background = this.add.image(0, 0, 'nivel4');
             ...
             //   this.showQuestion();
                ...
                this.villano = this.add.image(650, 500, 'villano4');
                ...
                this.drawOvals(this.questionBox);
                 ...
                 const scrumText = this.add.text(this.questionBox.x / 2, this.questionBox.y + 20, "XP\nNivel 4", {
                     fontSize: '10px',
            ...
            drawOvals(questionBox) {
                ...
                const opciones = questions4[this.currentQuestionIndex].options;
                // Dibuja tres óvalos
                for (let i = 0; i < 3; i++) {
            ...
            showQuestion(questionBox) {
                const question = questions4[this.currentQuestionIndex]; // Obtén la pregunta actual
            ...
            checkAnswer(selectedIndex) {
                const question = questions4[this.currentQuestionIndex];
